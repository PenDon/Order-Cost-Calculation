...
use app\modules\admin\modules\mail\forms\BatchSendForm;
use Yii;
use app\modules\admin\modules\mail\models\Email;
use app\modules\admin\modules\mail\models\EmailSearch;
...
class EmailController extends Controller
{
    ...
    public function behaviors()
    {
        return [
            'access' => [
                ...
                'rules' => [
                    [
                        'actions' => ['index', 'view', 'create', 'update', 'delete', 'batch-send'],
                        'allow' => true,
                        'roles' => ['@'],
                    ],
                ],
    ...
    /**
     * Creates a batch-send .
     * If creation is successful, the browser will be redirected to the 'view' page.
     * @return mixed
     */
    public function actionBatchSend()
    {
        $model = new BatchSendForm();
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            return $this->redirect(['index']);
        }
